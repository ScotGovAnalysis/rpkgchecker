# This simply generates the datasets that are used for manual checking and other processes
# To generate the html report for a particular package run create_rpackage_report.R
...
custom_sort_package_df(search_package, package_requirements_checked, "package")
